...
static const struct vkd3d_optional_extension_info optional_device_extensions[] =
{
    ...
    VK_EXTENSION_DISABLE_COND(NV_CLUSTER_ACCELERATION_STRUCTURE, NV_cluster_acceleration_structure, VKD3D_CONFIG_FLAG_STATIC(NO_DXR)),
    VK_EXTENSION_DISABLE_COND(NV_PARTITIONED_ACCELERATION_STRUCTURE, NV_partitioned_acceleration_structure, VKD3D_CONFIG_FLAG_STATIC(NO_DXR)),
        ...
        REFIID riid, void **object)
{
    ...
    if (IsEqualGUID(riid, &IID_ID3D12DeviceExt)
            ...
            || IsEqualGUID(riid, &IID_ID3D12DeviceExt6))
    {
...
extern CONST_VTBL struct ID3D12DeviceExt6Vtbl d3d12_device_vkd3d_ext_vtbl;
